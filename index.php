...
<div class="wrapper-main">
	...
	<div id="Intro" class='homeContent' style="display:block;">
		...
		<p>Co-expression analyses are useful tools for elucidating gene function.
		 Genes coordinatedly expressed with a gene of interest often functionally linked in the same biological pathway.
		...
		<sup class='ref'><a href="http://www.ncbi.nlm.nih.gov/pubmed/?term=24071852" target="_blank"
		   ...
		   genes from the same DNA segment with copy number alteration also become correlated despite a lack of shared biological functions. 
		...
		<p><b>Genomic Regression Analysis of Coordinated Expression (GRACE)</b> is a method developed to remove effect of copy number alteration from co-expression analysis so that the resulting genes are mostly based on biological regulation. 
		   ...
		   The users may apply either GRACE or standard, non-SCNA adjusted method to perform analysis with tumor sample data. Standard method may also be applied for normal tisssue samples, which lack frequent SCNAs. 
	...
	<div id="SCNA" class='homeContent'>
		...
		Consequently, RNA abundance and genomic copy number for genes from the same arm of chromosome 1 are strongly correlated. 
	...
	<div id="StandardAnalysis" class='homeContent'>
		...
		For example, the top 10 co-expressing genes for EIF2D, a gene on chromosome 1q32 encoding eukaryotic translation initiation factor 2D, are all located nearby or on the same cytoband. 
		This trend holds true for the top 200 co-expressing genes. 
		This bias introduced by SCNA is quite common in the cancer genome because of the ubiquity of SCNAs.</p>
	</div>
